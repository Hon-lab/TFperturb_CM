...
Analaysis of TF full dataset from IGVF - 2093 TFs, 705237 cells

Non-negative matrix factorization was done using cNMF package
...
# Mouse public dataset analysis
## Bulk RNA expression in heart
...
```
cd existing_repo
git remote add origin https://git.biohpc.swmed.edu/hon_lab/Anjana/tf-full.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.biohpc.swmed.edu/hon_lab/Anjana/tf-full/-/settings/integrations)
